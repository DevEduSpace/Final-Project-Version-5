  ...
  <div class="content">
    <div class="bodyCard">
      <div>
        ...
        <ul id="list">
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
              or
              &quot;Our&quot; in this Agreement) refers to EduSpace, 52 Ryneveld St, Stellenbosch Central, Stellenbosch,
              7600.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to EduSpace, accessible from <a href="https://EduSpace.ac.za"
                rel="external nofollow noopener" target="_blank">https://EduSpace.ac.za</a></p>
          </li>
          <li>
        ...
        <ul id="list">
          <li>
            <p>By email: support@eduspace.ac.za</p>
          </li>
          <li>
            <p>By visiting this page on our website: <a href="https://eduspace/contactus"
                rel="external nofollow noopener" target="_blank">https://eduspace/contactus</a></p>
          </li>
        </ul>
      </div>
    </div>
