  ...
  <div class="content">
    <div class="bodyCard">
      <div>
        ...
        <p><strong>Website</strong> refers to EduSpace, accessible from <a href="https://EduSpace.co.za"
            rel="external nofollow noopener" target="_blank">https://EduSpace.co.za</a></p>
        ...
        <ul id="list">
          <li>
            <p>By email: support@eduspace.co.za</p>
          </li>
          <li>
