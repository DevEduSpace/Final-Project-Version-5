<template>
  ...
  <div class="content">
    <div class="bodyCard">
      <div>
        <h1>Cookie Policy for EduSpace</h1>
        <p>This is the Cookie Policy for EduSpace, accessible from https://EduSpace</p>
        ...
        <p>This site offers e-commerce or payment facilities and some cookies are essential to ensure that your order
          is remembered between pages so that we can process it properly.</p>
        ...
        <p>From time to time we offer user surveys and questionnaires to provide you with interesting insights,
          ...
          has already taken part in a survey or to provide you with accurate results after you change pages.</p>
        ...
        <p>From time to time we test new features and make subtle changes to the way that the site is delivered. When
        ...
        <ul id="list">
          <li>
            <p>Email: support@eduspace.ac.za</p>
          </li>
        </ul>
